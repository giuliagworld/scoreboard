...
exports.updatePlayerScore = exports.removePlayer = exports.addPlayer = void 0;

var PlayerActionTypes = _interopRequireWildcard(__webpack_require__(/*! ../actiontypes/player */ "./src/actiontypes/player.js"));

var _player2 = _interopRequireDefault(__webpack_require__(/*! ../reducers/player */ "./src/reducers/player.js"));
...
var removePlayer = function removePlayer(index) {
  return {
...
var updatePlayerScore = function updatePlayerScore(index, score) {
  return {
...
exports.UPDATE_PLAYER_SCORE = exports.REMOVE_PLAYER = exports.ADD_PLAYER = void 0;
var ADD_PLAYER = 'player/ADD_PLAYER';
exports.ADD_PLAYER = ADD_PLAYER;
var REMOVE_PLAYER = 'player/REMOVE_PLAYER';
exports.REMOVE_PLAYER = REMOVE_PLAYER;
var UPDATE_PLAYER_SCORE = 'player/UPDATE_PLAYER_SCORE';
...
var PlayerActionCreators = _interopRequireWildcard(__webpack_require__(/*! ./actions/player */ "./src/actions/player.js"));

var _Header = _interopRequireDefault(__webpack_require__(/*! ./components/Header */ "./src/components/Header.js"));

var _Player = _interopRequireDefault(__webpack_require__(/*! ./components/Player */ "./src/components/Player.js"));

var _AddPlayer = _interopRequireDefault(__webpack_require__(/*! ./components/AddPlayer */ "./src/components/AddPlayer.js"));
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "players"
      }, playerComponents), _react.default.createElement(_AddPlayer.default, {
        addPlayer: addPlayer
      }));
    }
  }]);
...
function (_Component) {
  function AddPlayer() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddPlayer)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      name: ''
    ...
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addPlayer", function (e) {
      // prevent the form from submitting
      e.preventDefault(); // passing the name up the DOM tree
      // onAdd take a name to pass up

      _this.props.addPlayer(_this.state.name); // clear that last name from the state
...
var _Stats = _interopRequireDefault(__webpack_require__(/*! ./Stats */ "./src/components/Stats.js"));

var _Stopwatch = _interopRequireDefault(__webpack_require__(/*! ./Stopwatch */ "./src/components/Stopwatch.js"));
...
var Header = function Header(props) {
  return _react.default.createElement("div", {
    ...
    className: "h1"
  }, props.title), _react.default.createElement(_Stats.default, {
    players: props.players
  }), _react.default.createElement(_Stopwatch.default, null));
};
...
var _Counter = _interopRequireDefault(__webpack_require__(/*! ./Counter */ "./src/components/Counter.js"));
...
var Stats = function Stats(props) {
  ...
  return _react.default.createElement("table", {
    className: "stats"
  }, _react.default.createElement("tbody", null, _react.default.createElement("tr", null, _react.default.createElement("td", null, "Players:"), _react.default.createElement("td", {
    className: "value"
  }, totalPlayers)), _react.default.createElement("tr", null, _react.default.createElement("td", null, "Total Points:"), _react.default.createElement("td", {
    className: "value"
  }, totalPoints))));
};
...
function (_Component) {
  function Stopwatch() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Stopwatch)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      running: false,
      elapsedTime: 0,
      previousTime: 0
    ...
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onStop", function () {
      _this.setState({
        running: false
      });
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onReset", function () {
      _this.setState({
        elapsedTime: 0,
        previousTime: Date.now()
      });
    }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onTick", function () {
  ...
  _createClass(Stopwatch, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "h2"
      }, "Stopwatch"), _react.default.createElement("div", {
        className: "stopwatch-time"
      }, seconds), this.state.running ? _react.default.createElement("button", {
        onClick: this.onStop
...
var _player = _interopRequireDefault(__webpack_require__(/*! ./reducers/player */ "./src/reducers/player.js"));

var _app = _interopRequireDefault(__webpack_require__(/*! ./app */ "./src/app.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = (0, _redux.createStore)(_player.default, window.devToolsExtension && window.devToolsExtension());
